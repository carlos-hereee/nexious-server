...
const appSchema = new Schema<IAppSchema>(
  {
    ...
    taskBoard: { type: Schema.Types.ObjectId, ref: "BoardTasks" },
    taskBoards: { type: [{ type: Schema.Types.ObjectId, ref: "BoardTasks" }], default: [] },
    ...
    archivePosts: { type: [{ type: Schema.Types.ObjectId, ref: "Post" }], default: [] },
