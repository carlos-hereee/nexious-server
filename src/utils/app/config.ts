...
export const appSecret = process.env.APP_SECRET || "appSecretSHH";
export const accessTokenName = process.env.COOKIE_NAME || "nexios";
export const refreshTokenName = process.env.COOKIE_NAME_2 || "nexios2";
// export const mongooseUser = process.env.MONGOOSE_USERNAME || "";
// export const mongoosePassword = process.env.MONGOOSE_PASSWORD || "";
export const jwtPrivateKey = process.env.JWT_PRIVATE_KEY || "JWT_PRIVATE_KEY";
export const jwtPublicKey = process.env.JWT_PUBLIC_KEY || "JWT_PUBLIC_KEY";
